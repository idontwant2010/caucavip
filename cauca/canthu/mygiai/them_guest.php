...
if (!$user) {
    // Tạo user mới (guest)
    $nickname = 'nickgiai_' . rand(100001, 999999);
...
$note = "Được chủ giải mời";

// Thêm vào bảng giai_user
$stmt = $pdo->prepare("INSERT INTO giai_user (giai_id, user_id, nickname, trang_thai, note) VALUES (?, ?, ?, 'moi_cho_phan_hoi', ?)");
