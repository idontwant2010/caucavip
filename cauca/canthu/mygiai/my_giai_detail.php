...
<hr>
	<?php if ($giai['status'] === 'dang_cho_xac_nhan'): ?>
		<div class="mt-4 alert alert-success">
			...
			<div class="d-flex justify-content-center"> 
				<form method="post" action="my_giai_detail.php"  onsubmit="return confirm('Gửi xác nhận cho chủ hồ và trừ phí - <?= number_format($giai['phi_giai']) ?> vnd. Vui lòng kiểm tra ngày tháng, số cần, số bảng, khi giải kích hoạt thì Không sửa; Không hoàn phí ?')">
	...
	<?php if ($giai['status'] === 'chuyen_chu_ho_duyet'): ?>
		<div class="mt-4 alert alert-info">
			<p>🎯 Giải của bạn đã được gửi tới chủ hồ...!</p>
			<p>🎯 Vui lòng liên hệ chủ hồ để được duyệt nhanh hơn!</p>
			<div class="text-center mt-3">
				<a href="http://caucavip.test/cauca/canthu/giai/giai_ho_cau.php" class="btn btn-primary">
				👉 liên hệ chủ hồ ngay
				</a>
			</div>
		</div>
